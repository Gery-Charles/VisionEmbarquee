...
## Capture une scene avec objet a suivre
#
# Add some description of your module here.
#
# @author Charles Gery
# 
# @videomapping YUYV 640 480 29 YUYV 640 480 29 LicenceInfo CaptureScene1
# @email 
# @address 123 first street, Los Angeles CA 90012, USA
# @copyright Copyright (C) 2018 by Charles Gery
# @mainurl 
# @supporturl 
# @otherurl 
# @license 
...
class CaptureScene1:
    ...
    def process(self, inframe, outframe):
        ...
        # niveaux de gris
        imgris = cv2.cvtColor(inimg, cv2.COLOR_BGR2GRAY)
        outimg = cv2.GaussianBlur(imgris,(5,5),1)
        
        # Write a title:
        cv2.putText(outimg, "Hello World", (3, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0,0,255))
